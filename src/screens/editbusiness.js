...
import { updatebusiness } from '../functions/saveValue';
    ...
    const saveBussiness = () => {
        ...
        if (name != undefined && name.length > 0) {
            if (address1 != undefined && address1.length > 0) {
                ...
                business['image'] = image == undefined ? '' : String(image);
                ...
                updatebusiness(route.params.item._id, business).then(res => {
                    setLoading(false);
                ...
                <SafeAreaView style={{ flex: 1 }}>
                    <TouchableWithoutFeedback style={{ flex: 1 }} onPress={() => { Keyboard.dismiss() }}>
                        <View style={[styles.inner]}>
                            ...
                            <View style={{ marginHorizontal: onePerWidth * 10, width: onePerWidth * 80, alignSelf: 'center', marginTop: onePerHeight * 2 }}>
                                <TextInput style={[styles.input]} keyboardType='name-phone-pad' placeholderTextColor='#00000070'  placeholder={(name != undefined ** name.length > 0) ? name : 'My Business Name'} onChangeText={setName} />
